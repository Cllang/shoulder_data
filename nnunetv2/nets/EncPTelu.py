...
class PTeLU(nn.Module):
    def __init__(self, alpha=1.0, beta=1.0, learnable=False, inplace=True):
...
class BasicResBlock(nn.Module):
    def __init__(
        ...
        self.act1 = PTeLU(alpha=1.5, beta=0.8, learnable=False)
        
        self.conv2 = conv_op(output_channels, output_channels, kernel_size, padding=padding)
        self.norm2 = norm_op(output_channels, **norm_op_kwargs)
        # self.act2 = nonlin(**nonlin_kwargs)
        self.act2 = PTeLU(alpha=1.5, beta=0.8, learnable=False)
...
def get_EncPTelu_from_plans(
    ...
    segmentation_network_class_name = 'EncPTelu'
    network_class = EncPTelu
    kwargs = {
        'EncPTelu': {
