...
def get_umamba_bot_3d_from_plans(
    ...
    dim = len(configuration_manager.conv_kernel_sizes[0])  # 3
...
if __name__ == '__main__':
    ...
    plans = load_json('/data/item/U-Mamba/data/nnUNet_results/Dataset704_cuff934/nnUNetTrainer__nnUNetPlans__3d_fullres/plans.json')
    plans_manager = PlansManager(plans)
    configuration_manager = plans_manager.get_configuration('3d_fullres')
    dataset_json = load_json('/data/item/U-Mamba/data/nnUNet_results/Dataset704_cuff934/nnUNetTrainer__nnUNetPlans__3d_fullres/dataset.json')
    ...
    input_image = torch.randn([1, 1, 16, 384, 384]).float().cuda()
