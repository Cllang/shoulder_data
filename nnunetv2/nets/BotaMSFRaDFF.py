...
def get_BotaMSFRaDFF_from_plans(
    ...
    segmentation_network_class_name = 'BotaMSFRaDFF'
    network_class = BotaMSFRaDFF
    kwargs = {
        'BotaMSFRaDFF': {
            'conv_bias': True,
...
if __name__ == '__main__':
    ...
    model = get_BotaMSFRaDFF_from_plans(
        plans_manager,
        dataset_json,
