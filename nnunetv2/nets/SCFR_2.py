        ...
        for s in range(n_stages):
            if s == 0 or s==1:
                stage = nn.Sequential(
                    ...
                    AFEBlock(dim=features_per_stage[s])
                )
            else:
                stage = nn.Sequential(
                    BasicResBlock(
...
def get_SCFR_2_from_plans(
    ...
    segmentation_network_class_name = 'SCFR_2'
    network_class = SCFR_2
    kwargs = {
        'SCFR_2': {
            'conv_bias': True,
