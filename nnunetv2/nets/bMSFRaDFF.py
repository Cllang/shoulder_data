        ...
        for s in range(1, n_stages_encoder):
            ...
            stages.append(nn.Sequential(
                BasicResBlock(
                    ...
                    stride=1,
                    use_1x1conv=True
                ),* [ AFEBlock(dim=input_features_skip) for _ in range(n_conv_per_stage[s - 1] - 1)]
                # *[
                #     BasicBlockD(
                #         conv_op=encoder.conv_op,
...
def get_bMSFRaDFF_from_plans(
    ...
    segmentation_network_class_name = 'bMSFRaDFF'
    network_class = bMSFRaDFF
    kwargs = {
        'bMSFRaDFF': {
...
if __name__ == '__main__':
    ...
    model = get_bMSFRaDFF_from_plans(
        plans_manager,
        dataset_json,
