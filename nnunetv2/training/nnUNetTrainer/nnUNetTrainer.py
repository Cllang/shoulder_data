    ...
    def initialize(self):
        if not self.was_initialized:
            ...
            if self.is_ddp:
                ...
                self.network, self.optimizer, self.lr_scheduler = accelerator.prepare(self.network, self.optimizer,self.lr_scheduler)  # accelerate
                print('network,otimizer,scheduler have accelerated')
