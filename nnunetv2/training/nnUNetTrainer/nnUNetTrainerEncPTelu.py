...
from nnunetv2.nets.EncPTelu import get_EncPTelu_from_plans


class nnUNetTrainerEncPTelu(nnUNetTrainer):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = get_EncPTelu_from_plans(plans_manager,
                                     dataset_json,
                                     configuration_manager,
                                     num_input_channels,
                                     deep_supervision=enable_deep_supervision)

        print("EncPTelu: {}".format(model))
        return model
