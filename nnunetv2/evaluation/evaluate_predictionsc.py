...
if __name__ == '__main__':
    ...
    folder_ref = '/data/item/U-Mamba/data/nnUNet_raw/Dataset703_cuff934/labelsTr'
    folder_pred = '/data/item/U-Mamba/data/nnUNet_results/Dataset700_cuff924/nnUNetTrainerBotaMSFRaDFF__nnUNetPlans__3d_fullres/fold_0/validation/'
    output_file = '/data/item/U-Mamba/data/nnUNet_results/Dataset700_cuff924/nnUNetTrainerBotaMSFRaDFF__nnUNetPlans__3d_fullres/fold_0/validation//summary.json'
    image_reader_writer = SimpleITKIO()
    file_ending = '.nii.gz'
    regions = labels_to_list_of_regions([1, 2])
    ignore_label = None
    num_processes = 12
    metrics = compute_metrics_on_folder(folder_ref, folder_pred, output_file, image_reader_writer, file_ending, regions,
                              ignore_label,
                              num_processes)
    print(metrics['foreground_mean']["Dice"])